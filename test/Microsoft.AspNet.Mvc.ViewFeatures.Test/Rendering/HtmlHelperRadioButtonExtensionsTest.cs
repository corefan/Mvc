...
namespace Microsoft.AspNet.Mvc.Core
{
    ...
    public class HtmlHelperRadioButtonExtensionsTest
    {
        ...
        [InlineData("MyValue")]
        [InlineData("myvalue")]
        public void RadioButton_UsesSpecifiedExpressionCheckedWhenValueMatches(string value)
        {
            // Arrange
        ...
        [InlineData("MyValue")]
        [InlineData("myvalue")]
        public void RadioButtonFor_UsesSpecifiedExpressionCheckedWhenValueMatches(string value)
        {
            // Arrange
            var metadataProvider = new EmptyModelMetadataProvider();
            var helper = DefaultTemplatesUtilities.GetHtmlHelper(new ViewDataDictionary<TestModel>(metadataProvider));
